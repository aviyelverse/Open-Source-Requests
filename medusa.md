...
### [Code Enhancement/Feature Requests](#code-enhancementfeature-requests)
   1. [API: Complete a batch operation](#1-api-complete-a-batch-operation)
   2. [API: Cancel a batch operation](#2-api-cancel-a-batch-operation)
   3. [API: List batch operations](#3-api-list-batch-operations)
   4. [API: Get a batch job](#4-api-get-a-batch-job)
   5. [API: Create a batch operation](#5-api-create-a-batch-operation)
   6. [Implement OrderExportHandler](#6-implement-orderexporthandler)
   7. [Implement ProductImportHandler](#7-implement-productimporthandler)
   8. [Add DELETE /store/auth to @medusajs/medusa-js](#8-add-delete-storeauth-to-medusajsmedusa-js)
   9. [WebSocket/Server sent events implementation](#9-websocketserver-sent-events-implementation)
   10. [Update FileService to allow for protected uploads/downloads + streaming](#10-update-fileservice-to-allow-for-protected-uploadsdownloads--streaming)
   11. [Implement BatchJobService](#11-implement-batchjobservice)
   12. [Add POST/DELETE /admin/collections/:id/products/batch endpoints to @medusajs/medusa-js and medusa-react](#12-add-postdelete-admincollectionsidproductsbatch-endpoints-to-medusajsmedusa-js-and-medusa-react)
   13. [Enhancement: Ability to use admin middleware in custom APIs](#13-enhancement-ability-to-use-admin-middleware-in-custom-apis)
   14. [Select discount.rule.valid_for products by collection, type, and tags](#14-select-discountrulevalid_for-products-by-collection-type-and-tags)
...
### **1. API: Complete a batch operation**
...
### **2. API: Cancel a batch operation**
...
### **5. API: Create a batch operation**
...
### **6. Implement OrderExportHandler**
...
### **7. Implement ProductImportHandler**
...
### **8. Add DELETE /store/auth to @medusajs/medusa-js**
...
### **9. WebSocket/Server sent events implementation**
...
### **10. Update FileService to allow for protected uploads/downloads + streaming**
...
### **12. Add POST/DELETE /admin/collections/:id/products/batch endpoints to @medusajs/medusa-js and medusa-react**
...
### **13. Enhancement: Ability to use admin middleware in custom APIs**
...
### **14. Select discount.rule.valid_for products by collection, type, and tags**
